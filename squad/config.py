...
if os.path.isdir(hdd2):
	...
	path = home
train_file = os.path.join(path, "data", "squad", "train-v1.1.json")
dev_file = os.path.join(path, "data", "squad", "dev-v1.1.json")
test_file = os.path.join(path, "data", "squad", "dev-v1.1.json")
...
log_dir = os.path.join(path, "rnet", "squad", "log_new", "event")
save_dir = os.path.join(path, "rnet", "squad", "log_new", "model")
answer_dir = os.path.join(path, "rnet", "squad", "log_new", "answer")
...
flags.DEFINE_string("answer_dir", answer_dir, "Directory for saving answers")
...
flags.DEFINE_string("glove_file", glove_file, "Glove word embedding source file")
...
flags.DEFINE_boolean("limit_test", False, "limit test run upto certain range ")
flags.DEFINE_integer("run_length", 1, "test run upto run_length range ")
