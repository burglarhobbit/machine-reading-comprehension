...
log_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_new_initialization_values", 
						"log", "event")
save_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_new_initialization_values",
						"log", "model")
save_dir_temp = os.path.join(path, "rnet", "msmarco", "local_span_with_new_initialization_values",
						"log", "model")
answer_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_new_initialization_values",
						"log", "answer")
