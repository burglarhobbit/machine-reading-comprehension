...
log_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_var_summary_tf_api", "log", "event")
save_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_var_summary", "log", "model")
save_dir_temp = os.path.join(path, "rnet", "msmarco", "local_span_with_var_summary_tf_api", "log", "model")
answer_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_var_summary_tf_api", "log", "answer")
...
flags.DEFINE_boolean("is_debug", False, "tfdbg session")
flags.DEFINE_boolean("limit_test", False, "limit test run upto certain range ")
flags.DEFINE_integer("run_length", 3, "test run upto run_length range ")
