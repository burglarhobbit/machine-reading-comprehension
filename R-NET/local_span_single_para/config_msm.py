...
#target_dir = "data"
target_dir = os.path.join(path, "preprocess", "rnet", "msmarco", "local_span_single_para")
log_dir = os.path.join(path, "rnet", "msmarco", "local_span_single_para", "log", "event")
save_dir = os.path.join(path, "rnet", "msmarco", "local_span_single_para", "log", "model")
answer_dir = os.path.join(path, "rnet", "msmarco", "local_span_single_para", "log", "answer")
