...
def run_full_eval(model_dir, infer_model, infer_sess, eval_model, eval_sess,
                  ...
                  sample_ques_data, avg_ckpts=False):
...
def train(hparams, scope=None, target_session=""):
  ...
  run_full_eval(
      ...
      sample_tgt_data, sample_ques_data, avg_ckpts)
  ...
  (result_summary, _, final_eval_metrics) = (
      run_full_eval(
          ...
          summary_writer, sample_src_data, sample_tgt_data, sample_ques_data, avg_ckpts))
...
def _sample_decode(model, global_step, sess, hparams, iterator, src_data,
                   tgt_data, ques_data, iterator_src_placeholder, iterator_ques_placeholder,
