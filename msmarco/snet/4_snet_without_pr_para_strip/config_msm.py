...
log_dir = os.path.join(path, "snet", "snet_without_pr_para_strip", "log", "event")
save_dir = os.path.join(path, "snet", "snet_without_pr_para_strip", "log", "model")
save_dir_temp = os.path.join(path, "snet", "snet_without_pr_para_strip", "log", "model")
answer_dir = os.path.join(path, "snet", "snet_without_pr_para_strip", "log", "answer")
...
flags.DEFINE_boolean("use_cudnn_gru", True, "Whether to use cudnn rnn (should be False for CPU)")
