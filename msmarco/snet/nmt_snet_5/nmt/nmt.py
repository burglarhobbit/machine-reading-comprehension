...
def add_arguments(parser):
  ...
  parser.add_argument("--prefix_path", type=str, default=None,
                      help="prefix path, expect files with filename + src/tgt suffixes.")
  ...
  parser.add_argument("--vocab_prefix", type=str, default=None, help="""\
      ...
      """)
  parser.add_argument("--embed_prefix", type=str, default="glove.840B.300d", help="""\ # orig = None
  ...
  # Sequence lengths
  parser.add_argument("--src_max_len", type=int, default=400, #orig: 50
                      help="Max length of src sequences during training.")
  parser.add_argument("--tgt_max_len", type=int, default=20, #orig: 50
                      help="Max length of tgt sequences during training.")
  parser.add_argument("--src_max_len_infer", type=int, default=None,
                      help="Max length of src sequences during inference.")
  parser.add_argument("--tgt_max_len_infer", type=int, default=20, #orig: None
                      help="""\
  ...
  parser.add_argument("--batch_size", type=int, default=32, help="Batch size.") # orig: 128
