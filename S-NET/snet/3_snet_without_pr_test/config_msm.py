...
log_dir = os.path.join(path, "snet", "snet_without_pr_test", "log", "event")
save_dir = os.path.join(path, "snet", "snet_without_pr_test", "log", "model")
save_dir_temp = os.path.join(path, "snet", "snet_without_pr_test", "log", "model")
answer_dir = os.path.join(path, "snet", "snet_without_pr_test", "log", "answer")
