...
#target_dir = "data"
model = "snet"
title_prepro = "snet_refactored_from_rnet_with_pr"
title_output = "snet_refactored_from_rnet_with_pr_newgru"
target_dir = os.path.join(path, "preprocess", model, "msmarco", title_prepro)
log_dir = os.path.join(path, model, title_output, "log", "event")
save_dir = os.path.join(path, model, title_output, "log", "model")
save_dir_temp = os.path.join(path, model, title_output, "log", "model")
answer_dir = os.path.join(path, model, title_output, "log", "answer")
...
flags.DEFINE_list("bucket_range", [250, 1000, 50], "the range of bucket")
