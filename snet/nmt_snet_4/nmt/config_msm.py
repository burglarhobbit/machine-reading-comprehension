...
from analyze_dataset_2 import prepro_
...
flags.DEFINE_integer("beam_width", 12, "beamwidth for answer synthesis")
flags.DEFINE_integer("patience", 3, "Patience for learning rate decay")
flags.DEFINE_integer("vocab_size", 30000, "Vocab size for decoder")
flags.DEFINE_integer("unk_id", 2, "unk idx id")
flags.DEFINE_integer("sos_id", 3, "sos idx id")
flags.DEFINE_integer("eos_id", 4, "eos idx id")
flags.DEFINE_string("attention","luong","attention type")
flags.DEFINE_string("attention_architecture","standard","attention architecture type: standard uses\
					top layer to compute attention")
flags.DEFINE_boolean("output_attention",True,"""Only used in standard attention_architecture. Whether use attention as
      				the cell output at each timestep.""")
flags.DEFINE_boolean("pass_hidden_state",True,"""Whether to pass encoder's hidden state\ 
					to decoder when using an attention based model.""")
